...
Atminties kaip funkcijos darbo sustabdymą reikia priskirti prie darbo su ne-suvokimais klase.

Atmintis yra "Aš" identiškumo pagrindas. Jos sustabdymas išliekant aktyviai valiai(valingai "Aš" pozicijai) atveda prie paradoksalios būsenos - subjektyvumo išsaugojimo nesiremiant suformuotomis ankstesnio gyvenimo eigos asmenybės struktūromis ir atitinkamo "atminties fono".

Sustabdantis atmintį veiksmas, identiškas veiksmui, kuris naudojamas dirbant su laiku - dėmesio sutelkimas ties šia akimirka slopinant garsinių ir kitų figūrų susidarymą laike. Atliekant šį veiksmą bet koks atsiminimas netenka savos visumos ir nesusijungia su kitais atsiminimais į vieningą vientisą sistemą. Bet tai reiškia, pirma, suvokimo nebuvimo(jeigu šios akimirkos suvokimas nesiejamas su kitais, esančiais operatyvioje atmintyje, tai jis nesuvokiamas ir netampa pagrindine "Aš" orientacija ne-"Aš"-pasaulyje"), ir, antra, sprendimų priėmimo ir planavimo kaip veiklos, kuri sudaryta iš daugybės atskirai laike išsidėsčiusių aktų nutraukimas. Šiuo atveju išliekantis subjekto aktyvumas realizuojasi visai kitose formose, kurios nepasitaiko kasdieniniame gyvenime.

Bet pradinėse praktikos etapuose atminties sustabdymas nėra jau toks radikalus. Ne-atmintį galima stebėti kaip objektą, išsaugant atskiras "Aš" redukuotas operacijas. Tuo pačiu "Aš" susiejamas su laiko eiga, bet atsiminimų produkcija ir susiejimas jų su esamais suvokimais(jų pažinimas) visiškai sustoja.

Tam kad transformuoti nuslopintos atminties būseną į ne-suvokimo-objektą, į ne-atmintį, reikia išliekant ne atmintyje, atstatyti sąmonėje laiko kaip ne-formos eigą. Tada atsiranda ne-atminties, ir abstrakčios atminties pagrindo, ir atminties kaip fono stebėjimo galimybė.

Šioje pozicijoje išlieka ir išsaugoma viso darbo laiko eigoje beformė idėjos ne-atminties stebėjimo nuostata ir atminties darbo atnaujinimo draudimas. Sprendimas išeiti iš būsenos taip pat atliekamas tik valingu, neturinčiu apiforminimo ir atspindėtu tik idėjos patirtyje, veiksmu.

Toliau šis pasiekimas pasitarnaus alternatyvių asmenybės struktūrų formavimo pagrindu.

=== "Ne-suvokimų" ciklai

Ciklai ir ne-suvokimų perdengimai gali būti konstruojami taip pat, kaip ne-formų perdengimai. Tai leistinos procedūros. Bet jos gali būti panaudotos tik kruopščiai ištreniravus kiekvieną ne-suvokimo formą. Perdengimas atliekamas kaip nuoseklus ne-suvokimo zonos išplėtimas į gretimas aplinkas iki totalaus ne-suvokimo. Tai atliekant ne-suvokimai  netenka savo modalumo bruožo, ir realumas "Aš" išorėje tampa totaliu visko nebuvimu, fundamentalia tuštuma.

=== Ne-suvokimai ir "Aš" dinamika

Dar kartą pabrėšime tai kas buvo pasakyta šeši taškas šeši punkte: aprašytos procedūros veda prie ypatingų objektų klasių formavimo, į kuriuos galima žvelgti kaip į ypatingos "ne-suvokimo" būsenos, būdingos kai kurioms tradicinėms praktikoms, formavimo aprašymą. Bet tai tik aprašymas, o ne pati būsena. Perėjimas nuo aprašymo į realią patirtį reikalauja gilaus susikoncentravimo ties ne-suvokimo-objektais ir reikalavimo subjektui absorbuoti šiuos objektus.

Totalaus ne-suvokimo formavimo pasekmė, natūralu, "Aš" pokytis. Pirmoje valios meditacijos fazėje, kada dominuoja figūratyvinis suvokimas, "Aš esu" formulė apiforminama kaip nebylus žodžio tarimas, skambėjimas arba vaizdinys, tai yra kaip figūra. "Aš" atsispindi(ne susitapatina, bet atsispindi) figūraciniame sluoksnyje taip pat kaip figūra, žodinė arba vaizdinė.

Dėmesio dekoncentracijos stadijoje "Aš esu" išpakuojamas kaip būsena, nes "Aš" "tarimas" apie save įmanomas tik kaip "tarimas-fonas" - nieko kito "Aš" nurodyti negali. "Ne-Aš" realumas dėmesio dekoncentracijoje - tai fono, o ne objekto realybė.

Pereinant prie ne-formų "Aš" ne gali būti išreikštas(atspindėtas) jaučiamose formose(figūrose arba fone). "Aš esu" tampa ne būsena, o pozicija. Šiame lygmenyje valios meditacija tampa atskirta nuo bet kokių psichinių procesų.

Perėjimas prie ne-suvokimų reiškia "Aš esu" pozicijos panaikinimas. Tą momentą "Aš" netenka bet kokio apibrėžtumo, tampa grynu subjektu. Kokybinio "Aš" apibrėžtumo atstatymas reiškia totalaus ne-"Aš" neturinčio formos atstatymą. Tada "Aš" - ne-"Aš" sąsaja vėl tampa pozicija.

Aprašant perėjimą nuo "Aš", kuris susietas su ne-formomis, kaip "Aš", susietu su ne-suvokimais, atsiranda terminologiniai niuansai, susiję su skirtingais "Aš" apibrėžimais. "Aš" ne tapatus asmenybės struktūroms, - bet ar į "Aš" sąvoką patenka kokybinis apibrėžtumas kaip išreikšta duotis?

Jeigu "Aš" suprantamas kaip grynas subjektiškumas, tik turintis išsipakavimo į tą konkretų "Aš" potenciją, tai pereinant prie ne-suvokimo "Aš" išlieka. Jeigu "Aš" sąvokoje randasi jo išreikštas apibrėžtumas, tai poslinkis ne-suvokimo sluoksnyje traktuojamas kaip "Aš" išnykimas.

Mūsų požiūriu, kalbama apie terminologinį susitarimą. Perėjimas nuo ne-suvokimų į ne-formas, į foną ir figūratyvumą atstato "Aš" apibrėžtumą ir asmenybės struktūras į ankstesnį pavidalą. Esant sąlygai, aišku, kad nebuvo valingo ketinimo išpakuoti kitą "Aš" ir kitokią asmenybę. Bet toks ketinimas įmanomas tik gryno valingo subjektiškumo sluoksnyje, kuris randasi prieš idėjų sluoksnį.

== Darbas su "ne-formomis" ir "ne-suvokimais"

=== Imaginacijos ir jų panaudojimas darbe, Bespalvis švytėjimas ir juodos spalvos

Vaizduotė(imaginacija), kaip didelės budrumo funkcijos sudedamoji dalis, orientuota į darbą su pervestu į įsivaizdavimą sąmonės turinių masyvą ir įprastai priklauso nuo funkcionalios psichikos struktūros. Kalbama apie imaginaciją budrumo funkcijos sudedamąją dalį - sapne ir psichodelinėje patirtyje imaginacija gali funkcionuoti kitaip, kurianti visiškai naujus imaginacinius produktus.

"Savo apibrėžtumo srityje" imaginacija tiksli. Andrėj Paribok sąmojingai pastebėjo: bandant įnerti siūlą į adatą, mes galime nepataikyti į adatos auselę, bet įsivaizduojant šį veiksmą, mes negalime suklysti. Imaginacija gali būti nepakankamai diferencijuota ir todėl įsivaizduojant detales reikalauti daug energijos, bet objektas, kuris sukuriamas vaizduotės pagalba, ir sąlygojantis jos savybes ne transformuojasi į kitas detales: įsivaizduojant žalią kvadratą, galime neišlaikyti vaizduotėje visų keturių kampų, bet negalima dėl klaidos gauti geltoną apskritimą.

Kartu, už "apibrėžimo srities" ribų galima gauti naujus netrivialius turinius, kurie gali būti panaudoti psichonetiniame darbe. Apžvelgsime kai kurių tokių turinių gavimą, kurie savomis savybėmis artėja prie ne-formų ir gali būti panaudoti psichonetinių operacijų atlikime. Tokie turiniai tampa pirmais objektais, kurie atsirado "miegančių" funkcijų pažadinimo rezultate.

=== Bespalvis švytėjimas, takumas ir takus švytėjimas

Vienas iš būdų, kuris išveda vaizduotę į ribas "apibrėžimo ribas", - nuoseklus atėmimas iš realaus objekto kai kurių jį sudarančių kokybių išsaugant kitas. Taip, pavyzdžiui, įsivaizduojant ugnį, galima atimti iš jos karščio savybę, pavertus ją tik šviesos šaltinį, o vėliau, išlikus švytėjimui, nuosekliai pašalinti spalvos kokybę. Švytėjimas, kuris neturi spalvos - tai ne ryškai-baltas spindėjimas ir ne suvirinimo aparato veikimo skleidžiama spalva, - tai pakankamai abstrakti patirtis, išryškinanti švytėjimo patirtyje ne tik vizualinį, bet ir kitą komponentą. Tas kitas komponentas, išsipakuodamas vizualume, gali pridėti intensyvumo ir išsekimo kokybes, modifikuodamas vizualines išraiškas. Vis dėl to, būdamas izoliuotas nuo vizualumo, bespalvis švytėjimas tarsi duoda užuominą į kitą, neišpakuotą modalumą.

Intensyvumas ir išsekimas patys gali išsipakuoti į ypatingas formas, kurios atspindi aktyvumą ir potencialią objektų galią. Įmanoma aktyviai panaudoti švytėjimą ne-formų modifikavimui ir jų transformavimui į abstrakčias protoformas, o taip pat suvokimo valdymui. Taip, bespalvį švytėjimą galima išpakuoti į abstrakčią regėjimo plokštumą, suteikiant didesnį arba mažesnį intensyvumą jos išraiškai, o galima modifikuoti regėjimo aplinkos užmerktomis akimis švytėjimą.

Grynas takumas formuojamas panašiai kaip bespalvis švytėjimas: iš integralaus vandens vaizdinio nuosekliai šalinant drėgnumą ir tankį. Takumo perkėlimas į somatinę aplinką padidina kūno lankstumą, o takumo kokybės apčiuopimas gamtoje padeda aptikti judrumo ir tendencijos kisti aspektus suvokiant Pasaulį.

Įmanomas švytėjimo ir takumo apjungimas į vientisą integralinį objektą. Toks apjungimas taip pat yra funkcijos ir modalumo protėvis, kurie atitinka tam tikrus Pasaulio aspektus ir aktyviame moduse, kuris veikia jį.

=== "Neegzistuojančios spalvos"

Naudojant vienų savybių pašalinimą ir kitų prijungimą, galima gauti spalvą, kurios nėra realioje patirtyje. Vidinė "spalvų algebra" pagrįsta vienos iš trijų pirminių spalvų - raudonos, mėlynos ir geltonos, dviejų achromatinių - juodos ir baltos patirtimi, o taip pat, jeigu taip galima pasakyti atlikus spalvų "sudėties" veiksmo gautų spalvų. Taip, iš mėlynos ir raudonos galim gauti violetinę, iš mėlynos ir geltonos - žalią ir taip toliau. Leidžiamos taip pat atvirkštinės operacijos - iš sudėtinių spalvų "atėmimas" jų komponentų: atimant iš oranžinės raudoną, gausime geltoną, ir taip toliau.

Spalvos susijusios su pirmine idėjų patirtimi - neįmanoma žodžiais paaiškinti žodžiais subjektyvaus žalios ir mėlynos spalvos skirtumų nuo gimimo aklam žmogui. Atliekant "algebros" operacijas su realiomis spalvomis ir remiantis anksčiau išmokta idėjų išpakavimo procedūra ir jausmais apčiuopiamų formų supakavimą į idėjų patirtį, reikia perkelti operacijas iš spalvų formų aplinkos į idėjų aplinką. Tada idėjų "sudėties" ir "atimties" operacijos spalvų ekvivalentai atitiks šių operacijų projekciją spalvų aplinkoje. Atliekant spalvų idėjų "sudėtį" arba "atimtį", reikia išpakuoti rezultatą ir sulyginti jį su "spalvų algebros" rezultatais. Sekantis uždavinys netoks trivialus: "atimtis" iš bazinių spalvų - iš raudonos atimti mėlyną, iš mėlynos - geltoną arba žalią ir taip toliau. Rezultatai bus už vizualios spalvinės funkcijos "apibrėžimo srities" - jų negalima nei pamatyti, nei įsivaizduoti, bet galima išpakuoti kaip spalvinę patirtį, kuri neturi analogų kasdieninėje patirtyje.

Kitas neįprastų spalvų patirties gavimo būdas susijęs suteikiant juodai spalvai spalvotos kokybę. Spalvų skirtumas atspindi skirtumus esančius spalvų idėjose, kurios gali būti išpakuotos skirtingose psichinėse aplinkose(iš čia Liušero koncepcija). Eilė idėjų, turinčių "spalvos potencialą", neišsipakavo į spalvas, bet galima atlikti jų projekciją į juodos spalvos patirtį, modifikuojant jos jaučiamas apraiškas.

Dažniausiai juoda spalva suvokiama kaip bet kokios spalvos buvimas, kažkas absoliučiai viską sugeriantis ir nieko neatiduodantis. Bet sujunginėjant juodos spalvos vaizdą su ta ar kita fundamentalia patirtimi ir lyginant rezultatus, galima gauti naujas spalvų patirtis, suteikiant idėjų projekcijoms į modalinę sritį jaučiamą bruožą.

Taip galima vizualizuoti absoliučiai juodą paviršių su neapšviečiama, tai yra, absoliučiai juoda anga jame. Paviršiaus juodumas ir angos, tunelio, duobės juodumas - tai skirtingos spalvos, nors jų pradinė, tai yra, nemodifikuotos idėjos projekcijos jaučiamas audinys identiškas. Galima praplėsti skirtingų "juodų spalvų" rinkinį: padaryti absoliučiai juodame fone ryškios juodos spalvos šaltinį(sujungiant juodo paviršiaus fragmentą su intensyviu bespalviu švytėjimu), juodą paviršių, apšviestą ir neapšviestą juoda spalva, juodo daikto šešėlį, apšviestą juoda spalva ir taip toliau. Taip gaunamas juodų spalvų rinkinys, praktikos eigoje palaipsniui artėja prie savarankiškų spalvų statuso.

Aišku, kad neįprastos spalvos nėra tikslas. Svarbu padaryti pirmą žingsnį link sąmonės išlaisvinimo nuo susiklosčiusių neurofiziologinių struktūrų diktato ir suteikimo sąmonei aktyvumo bruožo. O aktyvus bruožas - tai "miegančių" idėjų išpakavimas į jaučiamas formas, kurios neturi atitikmenų išreikštuose turiniuose.

=== Abstrakčios regėjimo plokštumos pasukimas
