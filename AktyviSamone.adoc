...
Помимо превращения ЛОВ в эллипсоид, возможны и другие изменения
формы ЛОВ — изгибание его в виде клюшки, придание ему формы любых
геометрических фигур. И, наконец, вращение в пространстве сложного
тела внимания. Способность плавно перемещать и вращать сложное тело
внимания без ее привязки к визуальным объектам дает возможность про-
извести еще две важные манипуляции с вниманием — придать ему форму
объекта и остановить работу внимания при наличии объекта.
