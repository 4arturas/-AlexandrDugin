...
=== Atlikimo technika
Valios meditacija yra pagrindinė technika psichotechniniame darbe. Jos paskirtis - pasiekimas trijų tarpusavyje susijusių pozicijų. Tai:
...
sąmonės
organizuotumų "Aš" darbas su visu psichokos totalumu.
